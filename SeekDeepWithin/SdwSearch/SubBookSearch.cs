...
{
   /// <summary>
   /// Search functions for sub books.
   /// </summary>
   public static class SubBookSearch
   {
      private static FSDirectory s_Directory;

      /// <summary>
      /// Gets the lucene directory for sub books.
      /// </summary>
      private static FSDirectory Directory { get { return SearchCommon.InitDirectory (ref s_Directory, "subbook"); } }

      /// <summary>
      /// Adds or Updates the index for the given item.
      /// </summary>
      /// <param name="item">Item to update index for.</param>
      public static void AddOrUpdateIndex (VersionSubBook item)
      {
      ...
      public static void AddOrUpdateIndex (IEnumerable<VersionSubBook> items)
      {
