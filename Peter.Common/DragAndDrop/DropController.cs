...
using Peter.Common.DragAndDrop.Adorners;
using Peter.Common.Utilities;

namespace Peter.Common.DragAndDrop
{
   /// <summary>
   /// A drag controller.
   /// </summary>
   public class DropController
   {
      ...
      protected virtual void Drop (Point mousePoint)
      {
         ...
         if (newItemsControl != null && oldItemsControl != null)
         {
            ...
            int insertIndex = newItemsControl.ItemContainerGenerator.IndexFromContainer (container);
